...
#DesignerProperty: Key: UnselectedPageColor, DisplayName: Unselected Page Color, FieldType: Color, DefaultValue: 0xFFFFFFFF
#DesignerProperty: Key: DisabledPageColor, DisplayName: Disabled Page Color, FieldType: Color, DefaultValue: 0xFF3C4043
...
Sub Class_Globals
	...
	Private m_BorderWidth As Float
	Private m_UnselectedPageColor As Int
	Private m_DisabledPageColor As Int
...
Private Sub ini_properties(Props As Map)
	...
	m_UnselectedPageColor = xui.PaintOrColorToColor(Props.GetDefault("UnselectedPageColor",xui.Color_White))
	m_DisabledPageColor = xui.PaintOrColorToColor(Props.GetDefault("DisabledPageColor",0xFF3C4043))
	
	'Background
	tabBackground_color = xui.PaintOrColorToColor(Props.Get("TabBackgroundColor"))
...
Private Sub Base_Resize (Width As Double, Height As Double)
  ...
  mBase.Color = xui.Color_Transparent
	...
	xpnl_parting_line.SetLayoutAnimated(0,0,0,mBase.Width,2dip)
...
Private Sub ini_layout
	...
	mBase.AddView(xpnl_tab_background,0,mBase.Height/2,mBase.Width,mBase.Height/2)
...
Private Sub changelabeltextcolor(active_view As B4XView,view_2 As B4XView,view_3 As B4XView,view_4 As B4XView,view_5 As B4XView)
	...
	If enable_selectedpage_color = True Then
		...
		view_2.TextColor = IIf(view_2.Enabled = False,m_DisabledPageColor,m_UnselectedPageColor)

		If tabmodes = "4Tabs"  Then
			view_3.TextColor = IIf(view_3.Enabled = False,m_DisabledPageColor,m_UnselectedPageColor)
			view_4.TextColor = IIf(view_4.Enabled = False,m_DisabledPageColor,m_UnselectedPageColor)

		End If

		If enable_middlebutton_astab = True Then

			view_5.TextColor = IIf(view_5.Enabled = False,m_DisabledPageColor,m_UnselectedPageColor)
...
If active_view.IsInitialized = True And icon2.IsInitialized = True Then
			...
			SetBitmapWithFitOrFill(view_2,ChangeColorBasedOnAlphaLevel(icon2,IIf(view_2.Enabled = False,m_DisabledPageColor,m_UnselectedPageColor)))
...
End If
		...
		If tabmodes = "4Tabs"  Then
			...
			If icon3.IsInitialized = True And icon4.IsInitialized = True Then
				...
				SetBitmapWithFitOrFill(view_3,ChangeColorBasedOnAlphaLevel(icon3,IIf(view_3.Enabled = False,m_DisabledPageColor,m_UnselectedPageColor)))
				SetBitmapWithFitOrFill(view_4,ChangeColorBasedOnAlphaLevel(icon4,IIf(view_4.Enabled = False,m_DisabledPageColor,m_UnselectedPageColor)))
...
If icon5.IsInitialized = True Then
				...
				SetBitmapWithFitOrFill(view_5,ChangeColorBasedOnAlphaLevel(icon5,IIf(view_5.Enabled = False,m_DisabledPageColor,m_UnselectedPageColor)))
...
#Region Properties
'Index = 1 to 5
Public Sub DisableTab(Index As Int)
	If Index = 1 Then
		xpnl_tab_1.Enabled = False
		xlbl_text_1.Enabled = False
		xicon_1.Enabled = False
	else if Index = 2 Then
		xpnl_tab_2.Enabled = False
		xlbl_text_2.Enabled = False
		xicon_2.Enabled = False
	else if Index = 3 Then
		xpnl_tab_3.Enabled = False
		xlbl_text_3.Enabled = False
		xicon_3.Enabled = False
	else if Index = 4 Then
		xpnl_tab_4.Enabled = False
		xlbl_text_4.Enabled = False
		xicon_4.Enabled = False
	else if Index = 5 Then
		xpnl_tab_5.Enabled = False
		xlbl_text_5.Enabled = False
		xicon_5.Enabled = False
	End If

End Sub

'Index = 1 to 5
Public Sub EnableTab(Index As Int)
	If Index = 1 Then
		xpnl_tab_1.Enabled = True
		xlbl_text_1.Enabled = True
		xicon_1.Enabled = True
	else if Index = 2 Then
		xpnl_tab_2.Enabled = True
		xlbl_text_2.Enabled = True
		xicon_2.Enabled = True
	else if Index = 3 Then
		xpnl_tab_3.Enabled = True
		xlbl_text_3.Enabled = True
		xicon_3.Enabled = True
	else if Index = 4 Then
		xpnl_tab_4.Enabled = True
		xlbl_text_4.Enabled = True
		xicon_4.Enabled = True
	else if Index = 5 Then
		xpnl_tab_5.Enabled = True
		xlbl_text_5.Enabled = True
		xicon_5.Enabled = True
	End If
End Sub
...
Public Sub setMiddleButtonSize(size As Double, BorderWidth As Double)
	...
	xpnl_middlebutton.SetColorAndBorder(middlebuttonbackground_color,m_BorderWidth,xui.Color_White,xpnl_middlebutton.Height/2)
...
Public Sub getMiddleButtonBackgroundColor As Int
	Return middlebuttonbackground_color
End Sub

Public Sub setMiddleButtonBackgroundColor(Color As Int)
	 middlebuttonbackground_color = Color
	xpnl_middlebutton.SetColorAndBorder(middlebuttonbackground_color,m_BorderWidth,xui.Color_White,xpnl_middlebutton.Height/2)
End Sub

Public Sub getUnselectedPageColor As Int
	Return m_UnselectedPageColor
End Sub

Public Sub setUnselectedPageColor(Color As Int)
	m_UnselectedPageColor = Color
End Sub
